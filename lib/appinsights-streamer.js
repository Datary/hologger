 ...
 */
function AppinsightsStreamer(library, isil){
    ...
    this._minLogLevel = process.env.APPINSIGHTS_LOG_LEVEL || 0;
 ...
 *
 */
AppinsightsStreamer.prototype._serializeObject = function(obj){
...
AppinsightsStreamer.prototype._log = function(gate, info){
    ...
    else return gate(info.slug, AAI_SEVERITY_LEVEL, info); 
};
