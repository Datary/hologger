...
Streamer.prototype._publish = function(level){
    ...
    return function(event, info){
        ...
        switch (level){
            case "debug": return self._log(self._debugDrain, info);
            case "info": return self._log(self._infoDrain, info);
            case "notice": return self._log(self._noticeDrain, info);
            case "warning": return self._log(self._warningDrain, info);
            case "error": return self._log(self._errorDrain, info);
            case "critical": return self._log(self._criticalDrain, info);
            case "alert": return self._log(self._alertDrain, info);
            case "emergency": return self._log(self._emergencyDrain, info);
        }
    };
};
