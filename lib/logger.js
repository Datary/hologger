...
Logger.prototype.attach = function(isil, library){
    //se intenta localizar la librery en un fichero logger.json
    if (arguments.length === 0) {
        const JSON_FILEPATH = findUp.sync('logger.json');
        if (JSON_FILEPATH) require(JSON_FILEPATH);
        //console.log(JSON_FILEPATH);
    }
