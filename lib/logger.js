...
Logger.prototype.init = function(){
    ...
    this.useStreamer("Local");


    //streamers opcionales
    process.env = process.env || {};
    if (process.env.LOGENTRIES_TOKEN) {
        this.enable(new LogentriesStreamer());
        this.useStreamer("Logentries");
    }
    if (process.env.APPINSIGHTS_INSTRUMENTATIONKEY)  {
        this.enable(new ApplicationInsightsStreamer());
        this.useStreamer("ApplicationInsights");
    }
 ...
 * @return {Logger} for chaining
 */
Logger.prototype.useStreamer = function(name) {
