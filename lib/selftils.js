 ...
 * @return 
 */
exports.composeCode = function(level, event, isbn){
    var LEVEL_CODE;
    switch (level) {
 ...
 * @return 
 */
exports.composeMessage = function(library, level, event, info){
    var MESSAGE;
    try {
        MESSAGE = handlebars.compile(library[level][event])(info);
    } catch (e) {
